...
//	public String getLunarMonthString(Context context,int month) {
//	 	if (day>=31){
//	 		day = 30;
//		}
//		if (month==0){
//	 		month =1;
//		}
//		return (leap ? "农历闰" : context.getResources().getString(R.string.txt_lunar)) +" "+ context.getResources().getStringArray(R.array.month_of_year)[month-1]
//				 + context.getResources().getStringArray(R.array.day_of_month_lunar)[day-1];
//	}
    ...
    public static void main(String[] args) {
        ...
        String year = lunar.animalsYear() + " " + lunar.cyclical();
        String month = lunar.toString();
        //String day = lunar.getChinaDayString(8);
