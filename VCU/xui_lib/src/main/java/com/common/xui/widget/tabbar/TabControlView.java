...
public class TabControlView extends RadioGroup implements HasTypeface {
    ...
    private void initAttrs(Context context, AttributeSet attrs) throws Exception {
        ...
        try {
            ...
            radius = attributes.getDimensionPixelSize(R.styleable.TabControlView_tcv_radius, 10);
            ...
            leftOption = attributes.getResourceId(R.styleable.TabControlView_tcv_left_option, R.drawable.tcv_left_option);
            leftOptionSelected = attributes.getResourceId(R.styleable.TabControlView_tcv_left_option_selected, R.drawable.tcv_left_option_selected);
            middleOption = attributes.getResourceId(R.styleable.TabControlView_tcv_meddle_option, R.drawable.tcv_middle_option);
            middleOptionSelected = attributes.getResourceId(R.styleable.TabControlView_tcv_meddle_option_selected, R.drawable.tcv_middle_option_selected);
            rightOption = attributes.getResourceId(R.styleable.TabControlView_tcv_right_option, R.drawable.tcv_right_option);
    ...
    private void update() {
        ...
        while (itemIterator.hasNext()) {
            ...
            if (i == 0) {
                //Left
                if (isRtl()) {
                    updateRadioButton(rb, rightOption, rightOptionSelected);
                } else {
                    updateRadioButton(rb, leftOption, leftOptionSelected);
                }
                ...
                //Middle
                updateRadioButton(rb, middleOption, middleOptionSelected);
            }
...
//        float radii = (float) DensityUtils.dp2px(getContext(), getMeasuredHeight());
//        float[] radiis = new float[]{radii, radii, radii, radii, radii, radii, radii, radii};
//        unselected.setCornerRadii(radiis);
